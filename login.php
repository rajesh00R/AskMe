...
<div class="top"><ul style="float:left; font-size:15px;margin-left:100px; padding:4px;">
    ...
    <div class="login"><div style=" text-align: center; "><h3 style="font-weight:bold;font-family:cursive;">LOGIN</h3></div>
...
<div class="mdl-textfield mdl-js-textfield" style="width: 50%;">
    <br><input class="mdl-textfield__input" type="password" name="password" required>
    <label class="mdl-textfield__label" for="sample1">Password...</label>
</div><br><br>
  <button type="submit" name="login_user" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
  LOGIN
</button>
<br>
</form>
